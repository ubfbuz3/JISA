...
rate is \ResFpEthreeHits{}/\ResFpEthreeTotal{} = \ResFpEthreePct{}\%, but the
denominator is \ResFpEthreeTotal{}, so the rate is unstable by construction and
we do not attach an interval to it. With the legitimate-sharing
...
observation in these oracle-available scenarios, and that absence is decisive:
...
\subsection{Input-level specificity and scenario-level resolution}
