...
readable on \ResRsBlackboxSelfReadable{} of \ResRsBlackboxSelfCells{}: never.
(An intermediate count of \ResRsSelfReadable{}/\ResRsSelfTotal{} comes only from
subjects who happen to be owners or administrators, and does not constrain the
mechanism.) On \ResRsFidelityConsistent{} of \ResRsFidelityTotal{} applicable
...
(mirroring the admissibility condition), which production Gitea does not---hence
subject-vantage rows readable here and unobservable there
(\ResRsSelfReadable{}/\ResRsSelfTotal{} vs.\
\ResRsOwnerReadable{}/\ResRsOwnerReadableTotal{}); and the introspection surface
...
says \texttt{none} but no access succeeds). The central claim now has both
halves: when no vulnerability is present the metamorphic step adds nothing, and
when one is present the right adjudicator detects it without inventing others.
