...
scenario/configuration study; re-probed live authorization (the grantee's
response hash matched against the owner's, with a third account refused) for
Gitea and the cross-vendor systems; the pinned route tables for the grant census;
