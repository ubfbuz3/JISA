...
authorization state. Reading a testing technique's own reported metric as a
measurement instrument---with an explicit statement of what its denominator can
and cannot resolve---is the habit we would like this paper to encourage.
